...
use hearthline_config::service_name;

use super::{
    ScenarioConfig, ScenarioConnectionState, ScenarioExpectation, ScenarioExpectationMode,
    ScenarioExpectedOutcome, ScenarioFirewallHaState, ScenarioFirstHopState,
    ScenarioLinkAggregationState, ScenarioPacketConfig, ScenarioSecurityEvent,
...
pub struct ScenarioReport {
    ...
    #[serde(skip)]
    pub runtime: super::ScenarioRuntimeSnapshots,
}
