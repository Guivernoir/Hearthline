...
use super::super::state::RuntimeParameter;
use super::super::{HmiControlMode, HmiRecipe};
...
pub(super) fn operator_metadata(
    ...
    controller: &str,
) -> Result<OperatorMetadata, ConfigError> {
            ...
            configured_parameters
                ...
                .map(|parameter| {
                    Ok(RuntimeParameter {
                        ...
                        minimum: quantize(parameter.minimum)?,
                        maximum: quantize(parameter.maximum)?,
                        step: quantize(parameter.step)?,
                        value: quantize(parameter.initial_value)?,
                    })
                })
