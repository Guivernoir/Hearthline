<script lang="ts">
  ...
  import {
    customerDevices as devices,
    type CustomerDevice,
  } from "./customer-lan-model";
  ...
  $: selectedAppliances = selectedDevice
    ? findAppliancesForNode("customer/customer-lan", selectedDevice.id, viewMode)
    : [];
